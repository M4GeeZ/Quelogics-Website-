...
const CaseStudies = () => {
  return (
    <main className="explore-page detail-page explore-page--insights case-studies-page">
      ...
      <section
        className="detail-capabilities"
        id="case-study-capabilities"
      >
