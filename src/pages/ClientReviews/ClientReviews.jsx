...
const ClientReviews = () => {
  return (
    <main className="explore-page detail-page explore-page--insights client-reviews-page">
      ...
      <section className="detail-capabilities" id="review-capabilities">
